  ...
  render(){
    return (
      <Fade in={this.props.section03} timeout={1000}>
        <Grid item container style={{...Styles.fullHt, ...Styles.highZ, ...Styles.fixed}} alignItems="center" justify="center">
        <PreloadImage src={`${retrievePath()}homewo.jpg`} style={{position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: -1}}/>
