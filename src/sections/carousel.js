...
const LogoSvg = () => {
  return (
    <div>
      <svg width="207" height="364" viewBox="0 0 207 364" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="100.005" y="0.96875" width="5.32446" height="362.063" fill="white" />
        <path d="M0.171631 181.668C0.171631 173.03 7.17416 166.027 15.8122 166.027H83.3663V197.309H15.8122C7.17417 197.309 0.171631 190.306 0.171631 181.668Z" fill="white" />
        <path d="M123.3 166.027H190.854C199.492 166.027 206.494 173.03 206.494 181.668C206.494 190.306 199.492 197.309 190.854 197.309H123.3V166.027Z" fill="white" />
        <path
        ...
        <g filter="url(#filter0_d)">
          <g clip-path="url(#clip0)">
            <path d="M103.333 215.278C121.712 215.278 136.611 200.379 136.611 182.001C136.611 163.622 121.712 148.723 103.333 148.723C84.9539 148.723 70.0549 163.622 70.0549 182.001C70.0549 200.379 84.9539 215.278 103.333 215.278Z" fill="white" />
            <path
        ...
        <defs>
          <filter id="filter0_d" x="54.0816" y="140.736" width="98.5024" height="98.5024" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
          ...
          <clipPath id="clip0">
            <rect x="70.0549" y="148.723" width="66.5557" height="66.5557" rx="33.2779" fill="white" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
const CarouselContainer = ({ imagePath, text, name, profile }) => {
  return (
    <>
      <Grid item container justify="center" alignItems="center" style={{ width: "800px", height: "500px" }}>
  ...
  return (
    <>
      <Grid item container xs={12} justify="center">
        <Grid item container justify="center" alignItems="center" style={{ marginBottom: "40px" }}>
          <Typography variant="h1" style={{ ...Styles.colorRed }}>
            <span style={{ ...Styles.boldTxt }}>Meet</span> the <span style={{ ...Styles.boldTxt }}>super moms</span> who took
