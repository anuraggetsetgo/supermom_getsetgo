...
const Socialmedia = () => {
  return (
    <>
      <Grid container direction="column" alignItem="center" justify="center">
        <Grid item>
          <Typography variant="h1">Meet The super Moms</Typography>
        </Grid>
      </Grid>
      <Grid
        container
      ...
      >
        <Grid item xs={8} container alignItems="center" justify="center">
          If multi-tasking is the name of the game, these mom’s who have
          undergone our coaching program have become better multi-taskers and
          they are nowfully equipped to perform their best in all areas of their
          super busy life.
        </Grid>
        <Grid
          item
        ...
        >
          <Grid item>
            <Typography variant="h2">Are you the next SUPER MOM?</Typography>
          </Grid>
          <Signupform />
        </Grid>
      </Grid>
      ...
      <Grid container direction="column" alignItems="center" justify="center">
        <Grid item>
          <Typography variant="h3">Here is Why you need us</Typography>
        </Grid>
        <Grid item>
          <Typography variant="h1">More than 5000 Mom</Typography>
        </Grid>
        <Grid item>
          <Typography variant="h2">Have Transfoemed with us</Typography>
        </Grid>
      </Grid>
      <Grid container direction="row" alignItems="center" justify="center">
        <Grid item xs={2}>
          <Typography variant="h3">You Should Join Getsetgo if</Typography>
        </Grid>
        <Grid
          item
          xs={5}
          ...
          >
            ...
            <Grid item>
              <Typography variant="h5">
                You are happy with your looks and you want to look better
              </Typography>
            </Grid>
          </Grid>
          <Grid
      ...
      <Grid container direction="column" alignItems="center" justify="center">
        <Grid item>
          <Typography variant="h3">Why getsetgo fitness</Typography>
        </Grid>
      </Grid>
      <Grid contianer direction="column">
        <Grid
          ...
          justify="flex-start"
        >
          <Typography variant="h3">Google Rating and Review</Typography>
          <Typography variant="h6">Rating Stars</Typography>
        </Grid>
