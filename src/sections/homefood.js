      ...
      >
        <Grid item xs={5} style={Styles.padding5}>
          <Typography variant="h2" style={{ color: colors.grey }}>
            Home cooked food is great but cravings always kick-in specially when
            access to outside food is limited. Worry not, we will keep supplying
            you with simple recipes to jazz up your home cooked food.
          </Typography>
        </Grid>
        <Grid item xs={5}>
          <PreloadImage
            src={`${retrievePath()}recipe.jpg`}
