  ...
  render(){
    ...
    return (
      ...
      <Fade in={coachingDetails} timeout={200}>
        <Grid container style={{...Styles.highZ,...{position: 'fixed', top: 0, left: 0, height: `${docHt()}px`, paddingTop:'120px', visibility: coachingDetails?'visible':'hidden', width: '100%', background: '#000'}}} alignItems="flex-start" justify="center">
          ...
          <Grid item xs={8} style={{paddingTop: '100px', paddingBottom: '100px'}}>
            <div style={{textAlign: 'center', marginBottom: '50px'}}>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/K30LM1zrw7k" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen title="Client weight loss testimonial"></iframe>
            </div>
